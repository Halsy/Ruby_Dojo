...
# global variables                                                                                               #
##################################################################################################################
TITLE=                'template'                                               # title for header
...
DRILL_NAME=           '00 template'                                            # name of this drill
SAVED_DRILL_FILE=     'questions_file'                                         # file containing continued drill information
LANDMARK=             "HAROLDS PYTHON INVENTORY"                               # text to search for to begin processing
...
#                                                                                                                #
  ...
  result=0                                                                                                       #
  questions=Array.new(0){|index| index+1}                                                                        #
