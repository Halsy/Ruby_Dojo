...
# global variables                                                                                               #
##################################################################################################################
TITLE=                'lambdas'                                                # title for header
...
DRILL_NAME=           '18 lambdas'                                             # name of this drill
...
#                                                                                                                #
  ...
  result=0                                                                                                       #
  questions=Array.new(39){|index| index+1}                                                                       #
...
#..............................................................................
  question_string=<<-STRING
which is the correct way for using the call method to call a lambda with
no parameters?
STRING
  answer='my_lambda.call'
  answers=<<-STRING
my_lambda.call
my_lambda.(call)
my_lambda.[call]
...
#..............................................................................
  question_string=<<-STRING
write code to call a lambda with no parameters using the call method:
...
parameters?
STRING
  answer='my_lambda.call(parameter)'
  answers=<<-STRING
my_lambda.call(parameter)
my_lambda.(call)parameter
my_lambda.call[parameter]
my_lambda.call===parameter
STRING
...
#..............................................................................
  question_string=<<-STRING
write code to call a lambda with parameters using the call method:
...
#..............................................................................
  question_string=<<-STRING
write code to call a lambda without parameters using the () method:
...
#..............................................................................
  question_string=<<-STRING
what is the difference between a lambda and a proc when it comes to the
behavior of a return?
STRING
  answer='lambdas return control to calling code, procs goes to the next code'
  answers=<<-STRING
lambdas return control to calling code, procs goes to the next code
proc returns control to calling code, lambda goes to the next code
both return control to the calling code
both return control to the following code
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
what is the difference between a lambda and a proc when it comes to the
behavior of a call with improper number of arguments?
STRING
  answer='lambda will throw an exception'
  answers=<<-STRING
lambda will throw an exception
proc will throw an exception
lambdas dont care about arguments
procs dont have arguments
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
given the code below, what will be printed out?
...
#..............................................................................
  question_string=<<-STRING
write a lambda with the following:
...
parameter.......................num
block...........................num*3
puts............................the call to the lambda
STRING
answer=<<-STRING
triple_it=lambda{|num| num*3}
puts triple_it.call(2)
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write code to define the following lambda:

format.........................block
variable.......................my_lambda
using..........................lambda (keyword)
parameter......................variable
block..........................puts hello + variable (single quotes)
STRING
answer=<<-STRING
my_lambda=lambda do |variable|
  puts 'hello '+variable
end
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
...
#..............................................................................
  question_string=<<-STRING
which is a correct definition of a block form lambda with a parameter using
the lambda keyword?

a) my_lambda=lambda(parameter) do
     puts 'hello '+parameter
   end

b) my_lambda=lambda do |parameter|
     puts 'hello '+parameter
   end
STRING
answer=<<-STRING
...
using........................lambda (keyword)
parameter....................variable
block........................puts hello + variable
STRING
  answers=<<-STRING
my_lambda=lambda{|variable| puts 'hello '+variable}
my_lambda=lambda{|variable| puts "hello "+variable}
STRING
  result,drill_status=coding_test3(question_string,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
which is a correct definition of an inline lambda with a parameter and without
using the literal lambda operator?
STRING
  answer='my_lambda=lambda{|variable| block}'
  answers=<<-STRING
my_lambda=lambda{|variable| block}
my_lambda=lambda(variable){block}
my_lambda(variable)=lambda{block}
(variable)my_lambda=lambda{block}
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
block.........................puts hello (single quotes)
STRING
answer=<<-STRING
my_lambda=lambda do
  puts 'hello'
...
#..............................................................................
  question_string=<<-STRING
which is a correct definition of a block form lambda without a parameter and
without using the literal lambda operator?

a) my_lambda=lambda do
     puts 'hello'
   end
...
#..............................................................................
  question_string=<<-STRING
which is the correct definition of an inline lambda without a parameter and
without using the literal lambda operator?
STRING
  answer='my_lambda=lambda{block}'
  answers=<<-STRING
my_lambda=lambda{block}
my_lambda=->{block}
my_lambda=(lambda){block}
my_lambda={block}
STRING
...
#..............................................................................
  question_string=<<-STRING
given the code below, write code to create a pipeline then use each to
iterate over each lambda:

given.....................double_it=lambda{|num| num*2}
                          triple_it=lambda{|num| num*3}
                          half_it=lambda{|num| num/2}
                          value=5

use......................lambda_pipeline
pipe.....................double_it,triple_it,half_it
use variable.............lamb of each lambda
use iterator.............each (block form)
                         changing value each time
STRING
answer=<<-STRING
lambda_pipeline=[double_it,triple_it,half_if]
lambda_pipeline.each do |lamb|
  value=lamb.call(value)
end
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
lambdas enforce argument count. One way to prevent a lambda from throwing
an exception is to use a splat parameter. write code using a splat parameter:

create lambda.........................my_lambda
argement..............................arg (splat parameter)
iterate through args..................use each in block form
puts..................................'i saw '+arg (single quotes)
call lambda with args.................'a','b','c'
STRING
answer=<<-STRING
...
format................................block form
variable..............................my_lambda
using.................................literal lambda operator
parameter.............................variable
block.................................puts hello + variable (single quote)
STRING
answer=<<-STRING
my lambda=-> do |variable|
  puts 'hello '+variable
end
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
...
#..............................................................................
  question_string=<<-STRING
which is a correct definition of a block form lambda with a parameter using
the literal lambda operator?

a) my_lambda=-> do |parameter|
     puts 'hello '+parameter
   end

b) my_lambda=->(parameter) do
     puts 'hello '+parameter
   end
STRING
answer=<<-STRING
...
STRING
  answers=<<-STRING
my_lambda=->(variable){puts 'hello '+variable}
my_lambda=->(variable){puts "hello "+variable}
STRING
  result,drill_status=coding_test3(question_string,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
which is a correct definition of an inline lambda with a parameter using
the literal lambda operator?
STRING
  answer='my_lambda=->(variable){block}'
  answers=<<-STRING
my_lambda=->(variable){block}
my_lambda=->{|variable|block}
my_lambda(variable)=->{block}
(variable)my_lambda=->{block}
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
which is the correct definition of a block form lambda without a parameter
using the literal lambda operator?
...
#..............................................................................
  question_string=<<-STRING
which is a correct definition of an inline lambda without a parameter using
the literal lambda operator?
STRING
  answer='my_lambda=->{block}'
  answers=<<-STRING
my_lambda=->{block}
my_lambda=lambda{block}
my_lambda=(lambda){block}
...
#..............................................................................
  question_string=<<-STRING
which is the correct way for using the === method to call a lambda without parameters?
STRING
  answer='my_lambda.==='
  answers=<<-STRING
my_lambda.===
...
#..............................................................................
  question_string=<<-STRING
write code to call a lambda without parameters using === method:
...
#..............................................................................
  question_string=<<-STRING
which is the correct way for using the === method to call a lambda with
parameters?
STRING
  answer='my_lambda.===parameter'
  answers=<<-STRING
my_lambda.===parameter
my_lambda.parameter===
my_lambda.call[===]
...
#..............................................................................
  question_string=<<-STRING
write code to call a lambda with parameter while using === method:
...
#..............................................................................
  question_string=<<-STRING
which is the correct way for using the [] method to call a lambda without
parameters?
STRING
  answer='my_lambda.[]'
  answers=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
write code to call a lambda with parameters using the [] method:
