...
DRILL_NAME=           '04 input'                                               # name of this drill
...
#..............................................................................
    question_string=<<-STRING
when using 'gets', we also capture the newline character. what method can we
use to remove the newline character?
    STRING
    answer='chomp'
    answers=<<-STRING
chomp
...
#..............................................................................
    question_string=<<-STRING
what method do we use in ruby to get user input?
    STRING
    answer='gets'
    answers=<<-STRING
gets
...
use method:.................print (single quotes)
use string:.................what is your name?
use variable:...............name
    STRING
    answer=<<-STRING
...
#..............................................................................
    question_string=<<-STRING
what datatype does 'gets' receive by default?
    STRING
    answer='string'
    answers=<<-STRING
string
...
#..............................................................................
    question_string=<<-STRING
when using 'gets', what is captured by default? 
    STRING
    answer='newline'
    answers=<<-STRING
newline
...
#..............................................................................
    question_string=<<-STRING
when using 'gets' and the user types in the input with leading and trailing
white space, what method can we use to remove these? 
    STRING
    answer='strip'
    answers=<<-STRING
strip
...
what does the 'strip' method do? 
    STRING
    answer='removes leading and trailing white space'
    answers=<<-STRING
...
#..............................................................................
    question_string=<<-STRING
in ruby, what is considered as white space? 
    STRING
    answer='unprintable characters'
    answers=<<-STRING
...
#..............................................................................
    question_string=<<-STRING
which list contains white spaces? 
    STRING
    answer='null, horiz tab, line feed, vert tab, form feed, carriage return, space'
    answers=<<-STRING
null, horiz tab, line feed, vert tab, form feed, carriage return, space
null, tab, line feed, form feed, carriage return, space, nil
null, newline, tab, space, nil
null, tab, space, newline
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
  end 
...
#..............................................................................
    question_string=<<-STRING
which one stands for horizontal tab? 
    STRING
    answer="\\t"
    answers=<<-STRING
\\t
...
#..............................................................................
    question_string=<<-STRING
which one stands for line feed? 
    STRING
    answer="\\n"
    answers=<<-STRING
\\n
...
#..............................................................................
    question_string=<<-STRING
which one stands for vertical tab? 
    STRING
    answer="\\v"
    answers=<<-STRING
\\v
...
#..............................................................................
    question_string=<<-STRING
which one stands for form feed? 
    STRING
    answer="\\f"
    answers=<<-STRING
\\f
...
#..............................................................................
    question_string=<<-STRING
which one stands for carriage return? 
    STRING
    answer="\\r"
    answers=<<-STRING
\\r
