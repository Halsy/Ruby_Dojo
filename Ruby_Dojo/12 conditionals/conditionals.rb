...
# global variables                                                                                               #
##################################################################################################################
TITLE=                'conditionals'                                           # title for header
...
DRILL_NAME=           '12 conditionals'                                        # name of this drill
...
#                                                                                                                #
  ...
  result=0                                                                                                       #
  questions=Array.new(18){|index| index+1}                                                                       #
...
#..............................................................................
  question_string=<<-STRING
write a case statement that acts as a method call without a variable:

given.................................string='1234'
check for.............................numbers then letters
use...................................regexp, match, and []
puts message..........................'string contains (number/letters)'
default...............................'string does not contain numbers or letters'
STRING
answer=<<-STRING
puts case
...
when string.match(/[a-zA-Z]/)
  ...
  'string does not contain numbers or letters'
end
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write a case statement without a variable that checks strings:

given...............................string='geekforgeeks'
check for...........................numbers and letters
use.................................regexp, match, and []
puts message........................'string contains (numbers/letters)'
default.............................'string does not contain numbers or letters'
STRING
answer=<<-STRING
case
...
when string.match(/[a-zA-Z]/)
  ...
  puts 'string does not contain numbers or letters'
end
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write a case statement without a variable that checks ranges:

given.................................number=50
check for.............................ranges 1-10, 11-20, 21-30, 31-40, 41-50
puts message..........................'number is between (range)'
default...............................'number is not in range'
STRING
answer=<<-STRING
case number
when (1..10)
  puts 'number is between (1..10)'
when (11..20)
  puts 'number is between (11..20)'
when (21..30)
  puts 'number is between (21..30)'
when (31..40)
  puts 'number is between (31..40)'
when (41..50)
  puts 'number is between (41..50)'
else
...
#..............................................................................
  question_string=<<-STRING
write a case statement without a variable that checks for two values:

given.................................number=5
check for.............................two numbers starting with 1 and 2
puts message..........................'number is (the two numbers)'
up to.................................7 and 8
default...............................'number is not in range'
STRING
answer=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
write a case statement with a variable to do the following:

given....................................number=10
variable.................................variable
check for................................numbers by 5's
message..................................'number is (the number)'
up to....................................15
default..................................'number is not in range'
print message............................use puts
STRING
answer=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
write a case statement without a variable to do the following:

given...............................number=10
check for...........................numbers by 5's
puts message........................'number is (the number)'
up to...............................15
default.............................'number is not in range'
STRING
answer=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
other than if, if..elsif..else and ternary, what else can we use to check for
conditions in ruby?
STRING
...
#..............................................................................
  question_string=<<-STRING
in ruby, what is considered true and false?
STRING
  answer='only false and nil are considered false, everything else is true'
  answers=<<-STRING
only false and nil are considered false, everything else is true
only false and 0 are considered false, everything else is true
only false and -1 are considered false, everything else is true
only false is considered false, everything else is true
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
STRING
  answer='to execute a certain piece of code'
  answers=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
when is an if condition executed?
STRING
  answer='when the condition is true'
  answers=<<-STRING
when the condition is true
when the condition is false
when the condition evalutates to positive
when the condition evalutates to negative
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
what are the two ways that we can write a stand alone if statement?
STRING
  answer='if condition then execute code, execute code if condition'
  answers=<<-STRING
if condition then execute code, execute code if condition
if condition execute code, execute code if condition
if condition  execute code1 else execute code2, execute code1 or execute code2
if condition do else do, do or do if condition
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write code for a stand alone if statement in the inline format of:
[if condition then execute code]

given............................number=25
puts message.....................'number is even'
condition........................check if number is even
STRING
  answers=<<-STRING
if number.even? then puts 'number is even' end
...
#..............................................................................
  question_string=<<-STRING
what is the difference between a stand alone if statement and if..elsif..else
statement?
STRING
  answer='if statement will execute for each true case, if..elsif..else only once'
  answers=<<-STRING
if statement will execute for each true case, if..elsif..else only once
if statement is more efficient
if..elsif..else is more efficient
if statement will execute when false, if..elsif..else will execute when true
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
given...........................number=4
check...........................if number is less than numbers by 2's
puts message....................'number is less than (number being checked by)'
up to...........................6
default.........................'number is not in range'
STRING
answer=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
write code using ternary with a variable to check for the following:

given.......................string='accomplishment'
message.....................'larger than 4 characters' or less than 4 characters'
check.......................if string is greater than 4
variable....................var
STRING
  answers=<<-STRING
var=string.length>4 ? 'larger than 4 characters' : 'less than 4 characters'
var=string.size>4 ? 'larger than 4 characters' : 'less than 4 characters'
STRING
  result,drill_status=coding_test3(question_string,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write code using ternary without a variable to check for the following:

given.......................string='accomplishment'
puts message................'larger than 4 characters' or less than 4 characters'
check.......................if string is greater than 4 characters
STRING
  answers=<<-STRING
puts string.length>4 ? 'larger than 4 characters' : 'less than 4 characters'
puts string.size>4 ? 'larger than 4 characters' : 'less than 4 characters'
STRING
  result,drill_status=coding_test3(question_string,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
other than if, if..elsif..else and case, what other method can we use to perform
conditionals in ruby?
STRING
  answer='using ternary method'
  answers=<<-STRING
