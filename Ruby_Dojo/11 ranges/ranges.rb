...
DRILL_NAME=           '11 ranges'                                              # name of this drill
...
#                                                                                                                #
  ...
  result=0                                                                                                       #
  questions=Array.new(25){|index| index+1}                                                                       #
...
#..............................................................................
  question_string=<<-STRING
write code using case with ranges as conditions:

given......................score=70
variable...................result
0..40......................'fail'
41..60.....................'pass'
61..70.....................'pass with merit'
71..100....................'pass with honors'
...
result=case score
  ...
  when (71..100) then 'pass with honors'
  else 'invalid score'
end
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
...
#..............................................................................
  question_string=<<-STRING
when using ranges as a condition, which method can we use to do this?
STRING
  answer='case method'
  answers=<<-STRING
case method
...
#..............................................................................
  question_string=<<-STRING
write code to iterate over each interval in a range while printing
out each interval:

use range.............................1-10 inclusive
use variable..........................num
use to print..........................puts
format................................block
STRING
...
#..............................................................................
  question_string=<<-STRING
what can we use to iterate over each interval of a range?
STRING
  answer='each method'
  answers=<<-STRING
each method
...
#..............................................................................
  question_string=<<-STRING
what will be the interval of the following range?
...
#..............................................................................
  question_string=<<-STRING
what are the three ways ruby allows us to use ranges?
STRING
  answer='sequences, conditions, intervals'
  answers=<<-STRING
sequences, conditions, intervals
sequences, lists, ranges
sequences, intervals, count
sequences, arrays, ranges
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
what are ranges in ruby?
STRING
  answer='an interval set of values that have a start and an end'
  answers=<<-STRING
an interval set of values that have a start and an end
an ordered list of items
a list of items
ordered items from smallest to largest
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write code to check if the following range contains a particular value:
...
#..............................................................................
  question_string=<<-STRING
what method can we use to check if a range sequence has a particular value?
STRING
...
#..............................................................................
    question_string=<<-STRING
what does the n represent in the following?

given.....................(5..10).inject(1){|sum,n| sum+n}
    STRING
    answer='the current number from the collection'
    answers=<<-STRING
the current number from the collection
the second number
the first number
nil
    STRING
...
#..............................................................................
    question_string=<<-STRING
in the following program, what does the number 1 represent?

given.....................(5..10).inject(1){|sum,n| sum+n}
    STRING
    answer='it is the default number that sum will start with'
    answers=<<-STRING
it is the default number that sum will start with
it is the decimal palaces in a float
it is the number of items being added
it means how many digits to inject into the collection
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
  end
...
#..............................................................................
    question_string=<<-STRING
if we do not put the 1 as the default value of sum what will it be set to?
...
#..............................................................................
    question_string=<<-STRING
write code to sum all numbers in a range in in-line form but do not use the
'reduce' method
...
#=>..............................45
    ...
    STRING
    answer=<<-STRING
added_nums=(5..10).inject{|sum,num| sum+num}
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
  end
...
#..............................................................................
    question_string=<<-STRING
write code to multiply all numbers in a range in short form but do not use
the 'reduce' method.
...
#..............................................................................
    question_string=<<-STRING
write code to multiply all numbers in a range in block form but do not use
the 'reduce' method.
...
#=>..............................151200
    ...
    STRING
    answer=<<-STRING
product_nums=(5..10).inject do |product,num|
  product*num
end
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
...
#..............................................................................
    question_string=<<-STRING
write code to multiply all numbers in a range in in-line form but do not use
the 'reduce' method.
...
#=>..............................151200
    ...
    STRING
    answer=<<-STRING
product_nums=(5..10).inject{|product,num| product*num}
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
  end
...
#..............................................................................
    question_string=<<-STRING
write code to sum all numbers in a range in short form but do not use the
'reduce' method.
...
#..............................................................................
    question_string=<<-STRING
write code to sum all numbers in a range in block form but do not use the
'reduce' method.
...
#=>..............................45
    ...
    STRING
    answer=<<-STRING
added_nums=(5..10).inject do |sum,num|
  sum+num
end
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
...
#..............................................................................
  question_string=<<-STRING
write code to find the highest value in a range:
...
#..............................................................................
  question_string=<<-STRING
what method can we use to find the largest number in a range?
STRING
  answer='max method'
  answers=<<-STRING
max method
...
#..............................................................................
  question_string=<<-STRING
write code to find the smallest number in a range:
...
#..............................................................................
  question_string=<<-STRING
what method can we use to find the smallest value in a range?
STRING
  answer='min method'
  answers=<<-STRING
min method
...
#..............................................................................
    question_string=<<-STRING
what does the variable sum represent in the following?
...
given.....................(5..10).reduce(1){|sum,n| sum+n}
   STRING
    answer='it is the default number that sum will start with'
    answers=<<-STRING
it is the default number that sum will start with
it is the decimal palaces in a float
it is the number of items being added
it means how many digits to reduce to
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
  end
...
#=>..............................45
    ...
    STRING
    answer=<<-STRING
added_nums=(5..10).reduce{|sum,num| sum+num}
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
  end
...
#=>..............................45
    ...
    STRING
    answer=<<-STRING
added_nums=(5..10).reduce do |sum,num|
  sum+num
end
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
...
#=>..............................151200
    ...
    STRING
    answer=<<-STRING
multiplied_nums=(5..10).reduce{|product,num| product*num}
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
  end
...
#=>..............................151200
    ...
    STRING
    answer=<<-STRING
multiplied_nums=(5..10).reduce do |product,num|
  product*num
end
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
...
#..............................................................................
  question_string=<<-STRING
write code to reject numbers that are less than 5 putting the non-rejected
...
#..............................................................................
  question_string=<<-STRING
what method can we use to reject a certain group of numbers in a range
while creating a new array?
STRING
  answer='reject method'
  answers=<<-STRING
reject method
inject method
select method
...
#..............................................................................
  question_string=<<-STRING
write code to reject years from a range, rejecting years that are
not divisable by 4, while creating a new array. use in_line form.

given.................(1950..2000)
variables.............answer, year
  STRING
  answer=<<-STRING
answer=(1950..2000).reject{|year| year%4!=0}
  STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
end
...
#..............................................................................
  question_string=<<-STRING
write code to reject years from a range, rejecting years that are
not dividable by 4, while creating a new array. use block form.

given................(1950..2000)
variable.............answer, year
  STRING
  answer=<<-STRING
answer=(1950..2000).reject do |year|
year%4!=0
end
  STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
...
#..............................................................................
    question_string=<<-STRING
what is the select method used for with ranges?
    STRING
    answer='create a new array while selecting items to keep based on a condition'
    answers=<<-STRING
create a new array while selecting items to keep based on a condition
...
#..............................................................................
  question_string=<<-STRING
write code to select items to keep from a range while creating a new
array. keep items that are divisable by 7. use in-line form.
...
#..............................................................................
  question_string=<<-STRING
write code to select items to keep from a range while creating a new
array. keep items that are dividable by 7. use a block form.
...
#..............................................................................
  question_string=<<-STRING
write code to create a range sequence that is exclusive:
...
#..............................................................................
  question_string=<<-STRING
write code to create a range sequence that is inclusive:
...
#..............................................................................
  question_string=<<-STRING
what are the two ways we can build a range sequence?
STRING
  answer="using ' .. ' and ' ... '"
  answers=<<-STRING
using ' .. ' and ' ... '
...
#..............................................................................
  question_string=<<-STRING
how do we use ranges as sequences in ruby?
STRING
  answer='as an object with a start and end and a way to build it'
  answers=<<-STRING
as an object with a start and end and a way to build it
as a range
as an array
as an ordered list
STRING
...
#..............................................................................
  question_string=<<-STRING
write code to convert the following range into an array:

use range................................'a'-'z' exclusive
use variable.............................var
STRING
answer=<<-STRING
var=('a'...'z').to_a
...
#..............................................................................
  question_string=<<-STRING
write code to convert the following range sequence into an array:
...
#..............................................................................
  question_string=<<-STRING
what do we use to convert a range sequence into an array?
STRING
  answer='to_a method'
  answers=<<-STRING
to_a method
...
#..............................................................................
  question_string=<<-STRING
other than the include? method, what other method can we use to check if
an interval is within a range?
STRING
  answer='=== method'
  answers=<<-STRING
=== method
...
#..............................................................................
  question_string=<<-STRING
write code using if and ranges to check for intervals within the range:

use range..............................1-10 inclusive
print message..........................'5 lies in (1..10)
use to print...........................puts
check for..............................5
STRING
answer=<<-STRING
