...
# global variables                                                                                               #
##################################################################################################################
TITLE=                'methods'                                                # title for header
...
DRILL_NAME=           '17 methods'                                             # name of this drill
...
#                                                                                                                #
  ...
  result=0                                                                                                       #
  questions=Array.new(26){|index| index+1}                                                                       #
...
what is a block method?
    STRING
    answer='a method we can pass a block to'
    answers=<<-STRING
a method that contains blocks
a method that returns blocks
a method that returns nothing
a method we can pass a block to
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
  end
...
#.................................................................................
    question_string=<<-STRING
what method do we use in a block method to execute a block that we pass
to it?
    STRING
    answer='yield'
    answers=<<-STRING
...
#.................................................................................
    question_string=<<-STRING
write a generic block method that runs a block we pass to it

method name:...................my block method
    STRING
    answer=<<-STRING
def my_block_method()
  yield
...
#.................................................................................
    question_string=<<-STRING
using the following generic block method, send a block to print the answer
to 6+9. use puts

given:........................def my_block_method()
                                 yield
                              end
    STRING
    answer=<<-STRING
my_block_method{puts 6+9}
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
  end
...
#.................................................................................
    question_string=<<-STRING
using the following generic block method, send a block to print hello.
use puts
...
#.................................................................................
    question_string=<<-STRING
in a block method, what method do we use to check if a block has been
...
#.................................................................................
    question_string=<<-STRING
write a block method that takes a block that prints a name or else prints
no block given use puts.

method name:..................my block method
variable......................name
    STRING
    answer=<<-STRING
def my_block_method(name)
  if block_given?
    yield
  else
    puts 'no block given'
...
#.................................................................................
    question_string=<<-STRING
given the method, write code that will send a block to the method that
prints out a name. use puts.
...
given........................name='corvus'
    ...
    STRING
    answer=<<-STRING
my_block_method(name){puts name}
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
  end
...
#.................................................................................
    question_string=<<-STRING
write a method that runs a block we send it twice. then send a block to
the method to print hello. use puts.

method name:......................... print twice
    STRING
    answer=<<-STRING
def print_twice()
  yield
...
#.................................................................................
    question_string=<<-STRING
write a method that runs a block we send to it three times, each time
providing a different number to process such as 1, 2, and 3. then send
a block to the method to print the numbers provided by multiplying
them by 10

method name:.......................... one two three
...
#.................................................................................
    question_string=<<-STRING
yes or no, does the following block method require a parameter?

def game_method(player)
  if block_given?
    yield
  else
    puts 'no block given'
...
#.................................................................................
    question_string=<<-STRING
given the following program, what kind of parameter is presented?

given:...........................def print_name(name='none')
                                    puts(name)
                                 end
    STRING
...
what does a default parameter do?
    STRING
    answer='it uses a default value when no parameter is passed'
    answers=<<-STRING
it uses a default value when no parameter is passed
it uses the default value even if a parameter is passed
it uses the default value if the parameter passed is nil
it uses the default value if the parameter is zero
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
  end
...
#.................................................................................
    question_string=<<-STRING
write code to use a default parameter if no value is passed. use implicit
return.

method name:...........................age
variable:..............................age_given
set default to.........................none given
    STRING
    answer=<<-STRING
def age(age_given='none given')
  age_given
end
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
...
#.................................................................................
    question_string=<<-STRING
if our method has a return statement in it what type of return is this
called?
    STRING
    answer='explicit return'
    answers=<<-STRING
implicit return
explicit return
forced return
...
#.................................................................................
    question_string=<<-STRING
how do we name methods?
    STRING
    answer='same as local variables but can also contain ? and !'
    answers=<<-STRING
same as local variables but can also contain ? and !
same as arrays, plural
...
#.................................................................................
    question_string=<<-STRING
if our method modifies something we should name it with what?
    STRING
    answer='!'
    answers=<<-STRING
!
...
#.................................................................................
    question_string=<<-STRING
write a method that adds two numbers and returns the answer use an
implicit return
...
#.................................................................................
    question_string=<<-STRING
if our method returns a value but does not have a return statement in it
what type of return is this called?
    STRING
    answer='implicit return'
    answers=<<-STRING
implicit return
explicit return
forced return
...
#.................................................................................
    question_string=<<-STRING
write a method call to a method that adds two numbers
...
#.................................................................................
    question_string=<<-STRING
in the following given program, what type of parameter is presented?

given:...............................def number_list(*numbers)
                                        numbers
                                     end
    STRING
    answer='splat parameter'
    answers=<<-STRING
splat parameter
default parameter
implicit parameter
...
#.................................................................................
    question_string=<<-STRING
what are splat parameters used for?
    STRING
    answer='take unknown number of values'
    answers=<<-STRING
take unknown number of values
take pointer values
take up to 10 values
take power of values
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
  end
...
#.................................................................................
    question_string=<<-STRING
what is a splat parameter, really?
    STRING
    answer='an array'
    answers=<<-STRING
an array
...
#.................................................................................
    question_string=<<-STRING
write code using a splat parameter. use implicit return

method name:......................coordinates
splat parameter...................locations
    STRING
    answer=<<-STRING
def coordinates(*locations)
  locations
end
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
