...
#                                 general struct                                                                 #
#                                 open struct                                                                    #
#                                 returning attributes as array                                                  #
#                                 returning attributes as hash                                                   #
##################################################################################################################
...
DRILL_NAME=           '30 struct'                                              # name of this drill
...
#                                                                                                                #
  ...
  result=0                                                                                                       #
  questions=Array.new(29){|index| index+1}                                                                       #
...
#..............................................................................
  question_string=<<-STRING
what happens if a struct object is accessed through an attribute that was not
defined?
STRING
  answer='an exception will be thrown'
  answers=<<-STRING
an exception will be thrown
the attribute will be accessed
the attribute will be created
the attribute will be over written
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write code using the passed symbols to access a value in a struct:

given...............................Computer=Struct.new(:type,:os)
instantiate.........................laptop
type................................pc
os..................................windows
access and change...................type
type................................asus
access and print....................type (use puts)
STRING
answer=<<-STRING
laptop=Computer('pc','windows')
laptop.type='asus'
puts laptop.type
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
...
type................................pc
os..................................windows
access and change...................os
os..................................linux
access and print....................os (use puts)
STRING
answer=<<-STRING
laptop=Computer('pc','windows')
laptop.os='linux'
...
#..............................................................................
  question_string=<<-STRING
what are the two ways that we can access struct attributes?
STRING
  answer='instantiated_struct.symbol or instantiated_struct[:symbol]'
  answers=<<-STRING
instantiated_struct.symbol or instantiated_struct[:symbol]
instantiated_struct(symbol) or instantiated_struct[symbol]
instantiated_struct.:symbol or instantiated_struct(:symbol)
instantiated_struct[index] or instantiated_struct(index)
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write code to compare the two structs:

given...............................Player=Struct.new(:name,:score)
                                    player1=Player('Mark',1000)
                                    player2=Player('David',0)
use variable........................compare
print...............................compare (use puts)
STRING
answer=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
what do we use to compare structs in ruby?
STRING
  answer='=='
  answers=<<-STRING
==
...
#..............................................................................
  question_string=<<-STRING
write code to create a new struct:

create a struct......................computer
attributes...........................type
          ...........................os
STRING
answer=<<-STRING
Computer=Struct.new(:type,:os)
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
which syntax do we use to create a new struct?
STRING
  answer='Struct_name=Struct.new(:attribute1,:attribute2)'
  answers=<<-STRING
Struct_name=Struct.new(:attribute1,:attribute2)
struct_name=Struct.new(:attribute1,:attribute2)
Struct_name=struct.new(:attribute1,:attribute2)
Struct_name=Struct.new(attribute1,attribute2)
STRING
...
#..............................................................................
  question_string=<<-STRING
When creating a new struct what should we do with the struct name?
STRING
...
#..............................................................................
  question_string=<<-STRING
how do we create a new struct?
STRING
  answer='by using the Struct.new() method'
  answers=<<-STRING
by using the Struct.new() method
by using the def_Struct() method
by using the Struct keyword
by using the Struct() method
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write code to create a struct object:

given:..............................Rocket=Struct.new(:crew,:fuel)
variable_name.......................falcon
attributes..........................crew=3
          ..........................fuel=100
STRING
answer=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
how do we create a struct object given the struct below:

Computer=Struct.new(:type,:os)
STRING
  answer="variable_name=Computer('type','os')"
  answers=<<-STRING
variable_name=Computer('type','os')
def variable_name(Computer)
Computer(variable_name)='type','os')
variable_name.Computer('type','os')
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write code creating a struct with a method:

create a struct......................person
use attributes.......................name, age
method...............................greetings
greetings method prints..............hello my name is {name} (use puts)
STRING
answer=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
how do we create a struct that has methods?
STRING
  answer='by using the do keyword'
  answers=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
when should we not use a struct?
STRING
  answer='when the data does not stay the same and is mutated'
  answers=<<-STRING
when the data does not stay the same and is mutated
when the data stays static and does not change
when the data needs to be converted from one data type to another
when the data is not the same type
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
STRING
  answer='to make the data meaningful and when data is related to one another'
  answers=<<-STRING
to make the data meaningful and when data is related to one another
to make the data easier to maintain
to make the data returnable
to make the data mutatable
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
what is the one big draw back of open structs?
STRING
  answer="not good for the program's performace"
  answers=<<-STRING
not good for the program's performace
data is not mutable
data is not readable
not good for data storage
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
when should we use open structs?
STRING
  answer='in place of hashes and only during testing phases'
  answers=<<-STRING
in place of hashes and only during testing phases
in place of structs
in place of classes
in place of modules
STRING
...
#..............................................................................
  question_string=<<-STRING
open struct can take attributes after the struct is created, write code to
do this:

create an open struct...............person
give person a name attribute........Sam
give person a location attribute....USA
STRING
answer=<<-STRING
require 'ostruct'
...
#..............................................................................
  question_string=<<-STRING
when using an oper struct what do we need to do first?
STRING
  answer="require 'ostruct'"
  answers=<<-STRING
require 'ostruct'
import 'ostruct'
include 'ostruct'
...
#..............................................................................
  question_string=<<-STRING
what is an open struct?
STRING
  answer='it is similar to a struct only open to adding attributes'
  answers=<<-STRING
it is similar to a struct only open to adding attributes
it is more like a class than a struct
it is more like a hash than a struct
...
#..............................................................................
  question_string=<<-STRING
write code to return the struct attribute of the following as an array but
don't use the values method:

given................................Computer=Struct.new(:type,:os)
                                     desktop=Computer('pc','windows)
use variable.........................array
access and print.....................array (use puts inspect)
STRING
answer=<<-STRING
array=desktop.to_a
puts array.inspect
...
#..............................................................................
  question_string=<<-STRING
how do we return the attributes in a struct as an array?
STRING
  answer='by using the values method or to_a method'
  answers=<<-STRING
by using the values method or to_a method
by using the keys method or to_keys method
by using the include? method or index method
by using the to_h method or array() method
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write code to return the following attributes from a struct into a hash

given...............................Player=Struct.new(:name,:score)
                                    player1=Player('Dean',250)
use variable........................hash
print...............................hash (use puts)
STRING
answer=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
how do we return the attributes of a struct as a hash?
STRING
  answer='by using to_h method'
  answers=<<-STRING
by using to_h method
by using to_a method
by using hash.new method
by using hash() method
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
