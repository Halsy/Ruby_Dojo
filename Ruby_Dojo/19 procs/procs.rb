...
DRILL_NAME=           '19 procs'                                               # name of this drill
...
#                                                                                                                #
  ...
  result=0                                                                                                       #
  questions=Array.new(19){|index| index+1}                                                                       #
...
#..............................................................................
  question_string=<<-STRING
write code to call a proc without a parameter but don't use: call, [], ===
...
#..............................................................................
  question_string=<<-STRING
write code to call a proc without a parameter but don't use: (), [], ===
...
#..............................................................................
  question_string=<<-STRING
write code to call a proc with a parameter but don't use: (), [], ===
...
#..............................................................................
  question_string=<<-STRING
write code to call a proc with a parameter but don't use: call, [], ===
...
STRING
  answer='by using Proc.new or proc keyword'
  answers=<<-STRING
by using Proc.new or proc keyword
...
#..............................................................................
  question_string=<<-STRING
write code to define a proc but don't use the proc keyword:
...
#..............................................................................
  question_string=<<-STRING
write code to define a proc but don't use the Proc.new method:
...
what is a proc?
STRING
  answer='a block of code assignable to a variable'
  answers=<<-STRING
a block of code assignable to a variable
...
#..............................................................................
  question_string=<<-STRING
how will the following call to a proc be handled?

given proc..........................p = proc {|x, y| "x=#{x}, y=#{y}" }
given proc call.....................p.call(1, 2)
STRING
  answer='x=1, y=2'
  answers=<<-STRING
x=1, y=2
...
given proc call.....................p.call([1, 2])
STRING
  answer='x=1, y=2, array deconstructed'
  answers=<<-STRING
x=1, y=2, array deconstructed
x=[1,2], y=nil
x=nil, y=[1,2]
x=[1,2], y=[1,2], distributed
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
given proc..........................p = proc {|x, y| "x=#{x}, y=#{y}" }
given proc call.....................p.call(1, 2, 8)
STRING
  answer='x=1, y=2, extra argument discarded'
  answers=<<-STRING
x=1, y=2, extra argument discarded
x=[1,2], y=8, distribution
x=8, y=[1,2], inverse distribution
x=1, y=[2,8], redistribution
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
given proc..........................p = proc {|x, y| "x=#{x}, y=#{y}" }
given proc call.....................p.call(1)
STRING
  answer='x=1, y=nil, nil substituted instead of error'
  answers=<<-STRING
x=1, y=nil, nil substituted instead of error
x=1, y=0
x=1, y=null
x=1, y=''
STRING
...
#..............................................................................
  question_string=<<-STRING
what will procs do if they are given the wrong number of parameters?
STRING
  answer='process the data with no errors'
  answers=<<-STRING
process the data with no errors
throw an error
throw a hissy fit
ask for the corrent number of parameters
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
