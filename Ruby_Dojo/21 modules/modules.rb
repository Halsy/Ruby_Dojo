...
# global variables                                                                                               #
##################################################################################################################
TITLE=                'modules'                                                # title for header
...
DRILL_NAME=           '21 modules'                                             # name of this drill
...
STRING
  answer='modules cannot be instantiate'
  answers=<<-STRING
modules cannot be instantiate
classes do not contain methods
modules do not contain variables
classes do not return anything
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
how many modules can we mix into our classes?
STRING
...
#..............................................................................
  question_string=<<-STRING
how do we know to use a module instead of a class in our programs?
STRING
...
#..............................................................................
  question_string=<<-STRING
what do modules allow us to do?
STRING
  answer='add functionality to classes'
  answers=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
what are modules used mainly for?
STRING
  answer='grouping common methods'
  answers=<<-STRING
grouping common methods
grouping common classes
grouping common variables
...
what are modules?
STRING
  answer='modules are a collection of related methods'
  answers=<<-STRING
modules are a collection of related methods
modules are a collection of related variables
modules are a collection of related items
modules area library of related data types
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
what is it called when we put modules in our classes?
STRING
  answer='mixins'
  answers=<<-STRING
mixins
...
#..............................................................................
  question_string=<<-STRING
*define a module called flyable
  -flyable should have a method call fly
  -fly method should print 'i'm flying'
  -use puts to print
*define a class vehicle
*define a subclass car
*define a subclass plane
  -mixin the module flyable
*define a subclass jet
  -mixin the module flyable
STRING
answer=<<-STRING
module Flyable
...
#..............................................................................
  question_string=<<-STRING
we have already required the module laughable in our program, now
STRING
answer=<<-STRING
class Clown
  include Laughable
...
#..............................................................................
  question_string=<<-STRING
write code to mixin the module laughable into our program when the module is in
a folder called module2 inside the same folder as our program
STRING
answer=<<-STRING
require '/module2/Laughable'
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
write code to mixin the module laughable into our program when the module is not
in the same folder and is outside of this folder.
STRING
answer=<<-STRING
require '../Laughable'
STRING
...
#..............................................................................
  question_string=<<-STRING
write code to mixin the module laughable into our program when the module is in
the same folder as our program
STRING
answer=<<-STRING
require './Laughable'
STRING
...
#..............................................................................
  question_string=<<-STRING
when we use the include key word we are mixing in the module into our program
but at this point we still have not used the module. What keyword will we need
to use to use the module?
STRING
...
#..............................................................................
  question_string=<<-STRING
our modules can be in a separate file in another directory. How can we get it
into our program without copying it there?
STRING
  answer='by using the require keyword'
  answers=<<-STRING
...
#..............................................................................
  question_string=<<-STRING
write code to create an empty module called kissable. make sure the module is
complete.
STRING
answer=<<-STRING
module Kissable
...
STRING
  answer='by using the module keyword'
  answers=<<-STRING
by using the module keyword
by using the def keyword
by using begin and end
...
#..............................................................................
  question_string=<<-STRING
what is a common naming convention when it comes to modules?
STRING
  answer="to use a verb to describe the behavior and end it with 'able'"
  answers=<<-STRING
to use a verb to describe the behavior and end it with 'able'
to use a noun to describe the module and end it with yeah
...
#..............................................................................
  question_string=<<-STRING
what do we need to know when naming modules?
STRING
  answer='we need to capitalize the first character in the name'
  answers=<<-STRING
we need to capitalize the first character in the name
we need to use snake case
we need to use all caps
we need to put the name in quotes
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
does ruby have predefined modules ready for use? yes or no
STRING
answer=<<-STRING
yes
STRING
...
#..............................................................................
  question_string=<<-STRING
The following modules is in the same folder as our program. write code to
access the variable MAX_BITS_AND_TINKETS assigning the value to a variable
called max then use puts to print the value:  
...
access.............................MAX_NITS_AND_TRINKETS
assign to..........................max
print using........................puts
STRING
answer=<<-STRING
require './Bucket
max=Bucket::MAX_BITS_AND_TRINKETS
puts max
STRING
  result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
end  
...
#..............................................................................
  question_string=<<-STRING
the variable being accessed by the scope resolution operator must be were?
STRING
  answer='somewhere in our program'
  answers=<<-STRING
somewhere in our program
somewhere in another file
somewhere outside of our program
somewhere secure
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
...
STRING
  answer='it allows the access of varibles in another location'
  answers=<<-STRING
it allows the access of varibles in another location
it allows the access of passwords that are secret
it allows the access to free money
it allows the access to data types
STRING
  result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
end  
