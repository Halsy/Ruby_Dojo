...
DRILL_NAME=           '14 loops'                                               # name of this drill
...
#                                                                                                                #
  ...
  result=0                                                                                                       #
  questions=Array.new(27){|index| index+1}                                                                       #
...
#.................................................................................
    question_string=<<-STRING
what can we use with a begin statement, as a modifier, to create a loop?
    STRING
    answer="a 'while' or an 'until' modifier"
    answers=<<-STRING
a 'while' or an 'until' modifier
a 'do' modifier
a 'while' modifier
an 'until' modifier
    STRING
...
#.................................................................................
    question_string=<<-STRING
using a 'begin' statement, use a 'while' modifier to create a loop

use counter variable....................counter=1
use limit variable......................limit=5
print...................................counter
    STRING
    answer=<<-STRING
counter=1
...
#.................................................................................
    question_string=<<-STRING
using a 'begin' statement, use an 'until' modifier to create a loop that
prints out the counter variable
...
#.................................................................................
    question_string=<<-STRING
what should we remember when using a 'begin' loop?
    STRING
    answer='the loop runs once before the condition is evaluated'
    answers=<<-STRING
conditions are set before the loop and changes inside the loop
the loop runs once before the condition is evaluated
the loop automatically sets and changes the conditions
...
'5'
  if random_question==rolling_count
    #.................................................................................
    question_string=<<-STRING
other than using a conditional to control a loop, what is another way for us
to exit a loop?
    STRING
    answer="by using the 'break' method"
    answers=<<-STRING
by using the 'break' method
by using the 'next' method
by using the 'retry' method
by using the 'redo' method
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
  end
...
'6'
  if random_question==rolling_count
    #.................................................................................
    question_string=<<-STRING
write a for loop: that loops from one to five and prints out the counter
variable. use an if statement that breaks out of the loop when counter is
greater than 2:

counter variable...................counter
range..............................1..5
condition..........................end the loop if counter > 2
print..............................counter
    STRING
    answer=<<-STRING
for counter in (1..5)
...
#.................................................................................
    question_string=<<-STRING
what can we use to make the 'each' method perform like a loop?
    STRING
    answer='a range as a counter'
    answers=<<-STRING
a range as a counter
a hash as a counter
an array as a counter
a string as a counter
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
  end
...
#.................................................................................
    question_string=<<-STRING
write code to use an 'each' method as a loop. use a block form use puts to
print the contents of the 'counter' variable

use a range between 1 and 5
use counter variable....................counter
print...................................counter
    STRING
    answer=<<-STRING
(1..5).each do |counter|
...
#.................................................................................
    question_string=<<-STRING
what is another way for us to skip code and go into the next iteration
of a loop?
    STRING
    answer="by using the 'next' method"
    answers=<<-STRING
by using the 'break' method
by using the 'next' method
by using the 'retry' method
...
counter variable..................counter
range.............................1..5
condition.........................skip iteration if counter < 2
print.............................counter
    STRING
    answer=<<-STRING
for counter in (1..5)
...
#.................................................................................
    question_string=<<-STRING
using the 'times' method, write code to loop 100 times and print the count
from 1 to 100 in block form. use puts.
...
#.................................................................................
    question_string=<<-STRING
when using the 'times' method to create a loop, what index does the loop
start at?
    STRING
    answer='0'
    answers=<<-STRING
...
#.................................................................................
    question_string=<<-STRING
for loops execute once for each element in what?
    STRING
    answer='a range'
    answers=<<-STRING
a range
...
#.................................................................................
    question_string=<<-STRING
a for loop's conditional is separated from code by what?
    STRING
    answer="the reserved word 'do', a newline or a semicolon ;"
    answers=<<-STRING
the reserved word 'do', a newline or a semicolon ;
the reserved word 'do', a newline or pipes ||
the reserved word 'do', an 'end' or a backslash \\
the reserved word 'begin', a newline or a backslash \\
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
  end
...
#.................................................................................
    question_string=<<-STRING
what should we remember when using a for loop?
    STRING
    answer='the loop automatically sets and changes the conditions'
    answers=<<-STRING
conditions are set before the loop and changes inside the loop
the loop runs once before the condition is evaluated
the loop automatically sets and changes the conditions
...
what are loops used for?
    STRING
    answer='to iterate (repeat) through select code'
    answers=<<-STRING
to iterate (repeat) through a collection
to iterate (repeat) through select code
to read data
to access variables
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
...
'18'
  if random_question==rolling_count
    #.................................................................................
    question_string=<<-STRING
when using an 'until' loop, when does it execute the code?
    STRING
    answer='while the condition is false'
    answers=<<-STRING
while the condition is true
while the condition is false
when the condition is done
when the condition is not done
    STRING
    result,drill_status=multiple_choice(question_string,answer,answers,result,random_question,questions_to_go,drill_status)
  end
...
#.................................................................................
    question_string=<<-STRING
write code to use an 'until' loop to print out the counter variable
...
#.................................................................................
    question_string=<<-STRING
an until loop's conditional is separated from code by what?
    STRING
    answer="the reserved word 'do', a newline or a semicolon ;"
    answers=<<-STRING
the reserved word 'do', a newline or a semicolon ;
...
#.................................................................................
    question_string=<<-STRING
what should we remember when using a 'until' loop?
    STRING
    answer='conditions are set before the loop and changes inside the loop'
    answers=<<-STRING
conditions are set before the loop and changes inside the loop
the loop runs once before the condition is evaluated
the loop automatically sets and changes the conditions
...
#.................................................................................
    question_string=<<-STRING
using 'until' as a modifier, create an empty array then fill the array with
the numbers 1 through 9.

counter variable............................counter=0
limit variable..............................limit=9
create an empty array with 'new'............empty_array
    STRING
    answer=<<-STRING
counter=0
limit=9
empty_array=Array.new
empty_array<<counter+=1 until counter==limit
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
  end
...
#.................................................................................
    question_string=<<-STRING
when using a 'while' loop, when does it execute the code?
    STRING
...
#.................................................................................
    question_string=<<-STRING
a while loop's conditional is separated from code by what?
    STRING
    answer="the reserved word 'do', a newline or a semicolon ;"
    answers=<<-STRING
the reserved word 'do', a newline or a semicolon ;
...
#.................................................................................
    question_string=<<-STRING
write code to use a 'while' loop:
...
#.................................................................................
    question_string=<<-STRING
what should we remember when using a 'while' loop?
    STRING
    answer='conditions are set before the loop and changes inside the loop'
    answers=<<-STRING
conditions are set before the loop and changes inside the loop
...
#.................................................................................
    question_string=<<-STRING
using 'while' as a modifier, create an empty array then fill the array with
the numbers 1 through 9
...
limit=9
empty_array=Array.new
empty_array<<counter+=1 while counter<limit
    STRING
    result,drill_status=coding_test1(question_string,answer,result,random_question,questions_to_go,drill_status)
  end
